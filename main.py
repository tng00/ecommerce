...
from app.presentation.routers.auth_router import category, product, auth, permission, order, review, cart, events, search
...
from app.presentation.routers.auth_router import get_current_user, get_current_user_optional
